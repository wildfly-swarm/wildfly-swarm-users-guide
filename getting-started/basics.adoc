...
Fraction:: A well-defined collection of capabilities to add.  In some cases, a _fraction_ maps directly to a _subsystem_ from WildFly, but in other cases (e.g. <<../advanced/jolokia#,Jolokia>>) a fraction may involve different functionality.
