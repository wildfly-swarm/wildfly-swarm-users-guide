...
If you don't specify any WildFly Swarm fractions as dependencies, the maven plugin will auto-detect the fractions your application needs. See the <<plugins/maven-plugin#,Maven chapter>> for more details.
