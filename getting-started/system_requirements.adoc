...
WildFly leverages the Java 8 API's, in particular lambdas the the collection enhancements.
Therefore it's required to have the JDK 8 available, to build and run WildFly Swarm applications:
