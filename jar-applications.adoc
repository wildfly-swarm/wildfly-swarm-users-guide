...
Once a container is created, one or more _deployments_ may be created using ShrinkWrap and deployed into the container.  Please see the <<shrinkwrap#,chapter on ShrinkWrap>> for general details on how to create deployments.